                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('designation_name') is-invalid @enderror" 
                                   id="designation_name" name="designation_name" value="{{ old('designation_name') }}" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('designation_description') is-invalid @enderror" 
                                      id="designation_description" name="designation_description" rows="3">{{ old('designation_description') }}</textarea>
