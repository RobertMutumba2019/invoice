                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('user_surname') is-invalid @enderror" 
                                   id="user_surname" name="user_surname" value="{{ old('user_surname', $user->user_surname) }}" required>
                            @error('user_surname')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('user_othername') is-invalid @enderror" 
                                   id="user_othername" name="user_othername" value="{{ old('user_othername', $user->user_othername) }}">
