...
@section('title', 'Edit Good/Service')
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    ...
                    Edit Good/Service Information
                </h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('goods.update', $good->eg_id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('eg_name') is-invalid @enderror" 
                                   id="eg_name" name="eg_name" value="{{ old('eg_name', $good->eg_name) }}" required>
                            @error('eg_name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('eg_code') is-invalid @enderror" 
                                   id="eg_code" name="eg_code" value="{{ old('eg_code', $good->eg_code) }}" required>
                            @error('eg_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('eg_price') is-invalid @enderror" 
                                   id="eg_price" name="eg_price" value="{{ old('eg_price', $good->eg_price) }}" step="0.01" min="0" required>
                            @error('eg_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('eg_uom') is-invalid @enderror" 
                                   id="eg_uom" name="eg_uom" value="{{ old('eg_uom', $good->eg_uom) }}" required>
                            @error('eg_uom')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('eg_tax_category') is-invalid @enderror" 
                                ...
                                <option value="V" {{ old('eg_tax_category', $good->eg_tax_category) == 'V' ? 'selected' : '' }}>VAT</option>
                                <option value="Z" {{ old('eg_tax_category', $good->eg_tax_category) == 'Z' ? 'selected' : '' }}>Zero Rated</option>
                                <option value="E" {{ old('eg_tax_category', $good->eg_tax_category) == 'E' ? 'selected' : '' }}>Exempt</option>
                                <option value="D" {{ old('eg_tax_category', $good->eg_tax_category) == 'D' ? 'selected' : '' }}>Deemed</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('eg_tax_rate') is-invalid @enderror" 
                                   id="eg_tax_rate" name="eg_tax_rate" value="{{ old('eg_tax_rate', $good->eg_tax_rate) }}" 
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('eg_description') is-invalid @enderror" 
                                      id="eg_description" name="eg_description" rows="3">{{ old('eg_description', $good->eg_description) }}</textarea>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i>Update Good/Service
                        </button>
                    </div>
                </form>
            </div>
